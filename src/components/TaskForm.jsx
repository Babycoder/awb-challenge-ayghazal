  ...
  return (
    <div className="bg-white shadow-md rounded-md p-4 mb-4">
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className=" w-[120px] m-auto flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-700"
          >
          + Add Task
        </button>
            </div>
